...
export class ProjectScaffolder {
  public static detectProjectEnvironment(targetDir: string): { isTypeScript: boolean; isEsm: boolean; detectedFramework?: SetupAnswers['framework'] } {
    let isTypeScript = false;
    let isEsm = false;
    let detectedFramework: SetupAnswers['framework'] | undefined;
  ...
  public static updateEnvFile(targetDir: string, answers: SetupAnswers): string {
  ...
  public static createConfigFile(targetDir: string, answers: SetupAnswers): string {
...
`;
  ...
  public static scaffoldController(targetDir: string, answers: SetupAnswers): string[] {
