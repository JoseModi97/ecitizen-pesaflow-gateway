...
class EcitizenClient {
    ...
    constructor(settings) {
        ...
        this.gateway = new gateway_1.EcitizenGateway(config);
    }
    /**
    ...
    checkout(payment) {
        ...
        if (invoice.clientMSISDN) {
            invoice.clientMSISDN = phone_1.PhoneHelper.normalize(invoice.clientMSISDN);
        }
...
exports.EcitizenClient = EcitizenClient;
