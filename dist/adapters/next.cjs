...
exports.createNextAppRouteHandler = createNextAppRouteHandler;
exports.createNextPagesApiHandler = createNextPagesApiHandler;
/**
 ...
 *   });
 */
function createNextAppRouteHandler(client, options = {}) {
 ...
 */
function createNextPagesApiHandler(client, options = {}) {
